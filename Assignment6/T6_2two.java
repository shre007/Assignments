...
public class T6_2two {
	static class Emp{
		  public static void main(String[] args){
		    Employee e1 = new Employee("Robert", 1994,60000, "64C- WallsStreet");
		    Employee e2 = new Employee("Sam", 2000, 80000, "68d- WallsStreet");
		    Employee e3 = new Employee("John", 1999, 90000, "26B- WallsStreet");
